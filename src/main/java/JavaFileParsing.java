...
public class JavaFileParsing {
    static String baseDir = "/Users/kimtaehyeon_macbookm1/Desktop/test"; // 검색할 폴더 경로
    static String word = "a,b,c,d"; // 검색할 단어
    static String save = "/Users/kimtaehyeon_macbookm1/Desktop/"; // 검색 결과가 저장될 파일 경로
